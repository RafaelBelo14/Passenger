...
public class ConfigAlergiaAlimentar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSeguinte = (Button) findViewById(R.id.buttonSeguinteAlergiaAlimentar);
                            ...
                            .addOnCompleteListener(task -> {
                                if (task.isSuccessful()) {
                                    for (QueryDocumentSnapshot document : task.getResult()) {
                                        ...
                                        Intent intent = new Intent(ConfigAlergiaAlimentar.this, ConfigAlergiaComment.class);
                                        intent.putExtra("alergia", alergiaAlimentar);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ConfigAlergiaAlimentar.this, ConfigComidaFavorita.class);
                startActivity(intent);
            }
        });
