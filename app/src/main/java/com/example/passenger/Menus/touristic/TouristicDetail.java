...
public class TouristicDetail extends AppCompatActivity {
    ...
    public void initViews() {
        ...
        image = findViewById(R.id.detalhesTouristicImage);
        name = findViewById(R.id.detalhesTouristicName);
        vicinity = findViewById(R.id.detalhesTouristicVicinity);
        price_level = findViewById(R.id.detalhesTouristicPriceLevel);
        open_hours = findViewById(R.id.detalhesTouristicOpen);
    ...
    public void initIntentExtras() {
        ...
        //Vicinity
        if (getIntent().getExtras().getString("vicinity") == null) {
    ...
    public void clickExit(View view) {
        Intent intent = new Intent(TouristicDetail.this, StandByAssistant.class);
        intent.putExtra("mute", String.valueOf(mute));
