...
public class RestaurantDetail extends AppCompatActivity {
    ...
    public void initViews() {
        ...
        image = findViewById(R.id.detalhesRestaurantImage);
        name = findViewById(R.id.detalhesRestaurantName);
        vicinity = findViewById(R.id.detalhesRestaurantVicinity);
        price_level = findViewById(R.id.detalhesRestaurantPriceLevel);
        open_hours = findViewById(R.id.detalhesRestaurantOpen);
