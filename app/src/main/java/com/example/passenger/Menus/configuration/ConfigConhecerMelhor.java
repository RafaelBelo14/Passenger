...
public class ConfigConhecerMelhor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSeguinte = (Button) findViewById(R.id.buttonSeguinteConhecerMelhor);
        ...
        buttonSeguinte.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ConfigConhecerMelhor.this, ConfigDestinoSonho.class);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ConfigConhecerMelhor.this, ConfigRelation.class);
                startActivity(intent);
            }
        });
    }
