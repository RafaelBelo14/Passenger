...
public class LudicasDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switchCompat.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (mute) {
                    mute = false;
                    Toast.makeText(LudicasDetail.this, "Unmuted!", Toast.LENGTH_SHORT).show();
                }
                else {
                    mute = true;
                    Toast.makeText(LudicasDetail.this, "Muted!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void initIntentExtras() {
        ...
        if (getIntent().getExtras() == null) {
            initializeVoice();
            Toast.makeText(LudicasDetail.this, "No information about assistent voice", Toast.LENGTH_SHORT).show();
